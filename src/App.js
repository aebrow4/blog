...
export default class App extends Component {
      ...
      <div>
        ...
        <Post
          ...
          photos={[
            ...
            new Image(img2, img2Thumb, 'Feeding time at JFK Park, AKA \'the cat park\'. Hundreds of cats live in this downtown park.',''),
            new Image(img3, img3Thumb, 'Name: Princesa. Age: 6 months. Interests: Playing, being cute, biting. Mostly biting.', ''),
            new Image(img4, img4Thumb, 'Huaraz', ''),
            new Image(img5, img5Thumb, 'One of the \'low\' peaks (about 5500m) of the Cordillera Blanca.', ''),
            new Image(img6, img6Thumb, 'Cordillera Blanca', ''),
            new Image(img7, img7Thumb, 'Cusco', ''),
            new Image(img8, img8Thumb, 'Baby Alpacas', ''),
            new Image(img9, img9Thumb, 'A street cat making himself at home in a restaurant in Aguas Calientes', ''),
            new Image(img10, img10Thumb, 'Cordillera Vilcabamba. The beginning of the Salkantay trek to Machu Picchu', ''),
            new Image(img11, img11Thumb, 'Valley in the Cordillera Vilcabamba', ''),
            new Image(img12, img12Thumb, 'Milleigh Vo descends from the high point of the trek, Salkantay pass (4630m). Salkantay in the background (6271m).', ''),
            new Image(img13, img13Thumb, 'Salkantay', ''),
            new Image(img14, img14Thumb, 'Day three of the trek. A coffee stand and a few chickens perch on the side of the valley.', ''),
            new Image(img15, img15Thumb, 'Machu Picchu in the background: the leftmost peak, under the layer of clouds.', ''),
            new Image(img16, img16Thumb, 'Near Machu Picchu and Aguas Calientes', ''),
            ...
            new Image(img20, img20Thumb, 'The so-called \'face of the Inca\' is visible here...the Inca has a big nose.', ''),
  ...
  render() {
    return (
      <Router>
        <div className={`app bgg-grey-300 ${this.state.lightbox ? 'lightbox' : ''}`}>
          <header>
            <h1 className="fontSize-24 ccc-brown-300">Andy's witty blog title</h1>
          </header>
